...
Calculates molar weight of input formula. Multiple formulas can be passed as an array.
...
```julia-repl
julia> molecularwt("Na0.84Ca0.64K0.44Ba0.02Sr0.01Ca0.64Mn0.05Zn0.01Nb2.7Ti1.28Fe0.07Si7.97Al0.06O24.09OH1.23O2.75(H2O)6.92")
